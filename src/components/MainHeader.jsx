        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse justify-content-end text-uppercase fw-bold" id="nav">
            <ul className="navbar-nav fs-6">
              ...
              <li className="nav-item dropdown">
                <NavLink to="#" className="nav-link dropdown-toggle" data-bs-toggle="dropdown">Preparedness</NavLink>
                <ul className="dropdown-menu">
                  <li>
                    <NavLink to="/survival-tips" className={({ isActive }) => `dropdown-item ${isActive ? "active-link" : ""}`}>Survival Tips</NavLink>
                  </li>
                  <li>
                    <NavLink to="/training" className={({ isActive }) => `dropdown-item ${isActive ? "active-link" : ""}`}>Training & Certification</NavLink>
                  </li>
                  <li>
                    <NavLink to="/supplies-shops" className={({ isActive }) => `dropdown-item ${isActive ? "active-link" : ""}`}>Supplies Shops</NavLink>
                  </li>
                </ul>
              </li>
              <li className="nav-item">
